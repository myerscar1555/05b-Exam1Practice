...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         ...
         their colleagues, and Carter Myers.
...
def run_test_problem1a():
    ...
    # -------------------------------------------------------------------------
    # Test 3:
    expected = -0.919  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([4, 8], expected, test_results,
                                  format_string)
    actual = problem1a(4, 8)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
